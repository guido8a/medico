...
<div class="btn-toolbar toolbar">
    <div class="btn-group">
        <g:link class="btn btn-primary col-md-2" style="width: 100px;" controller="gestor" action="buscarGstr">
            ...
            <g:else>
                <g:if test="${gestorInstance?.estado == 'R'}">
                    <a href="#" id="btnDesRegistrar" class="btn btn-info">
                        <i class="fa fa-times"></i> Quitar registro
                    </a>
                </g:if>
            </g:else>
        </g:if>
...
<div class="vertical-container" style="margin-top: 25px;color: black">
    ...
    <div id="contenido">
        ...
        <div class="fila">
            ...
            <div class="col-xs-3 negrilla">
                <g:select class="form-control required" name="tipoGasto" id="tipoGasto"
                          from="${sri.TipoGasto.list(sort: 'descripcion')}" value="${gestorInstance?.tipoGasto?.id}" optionKey="id"
                          optionValue="descripcion" title="Tipo de gasto"   disabled="${gestorInstance?.estado == 'R'}"/>
            </div>
    ...
    <div class="vertical-container" style="margin-top: 25px;color: black; height: 500px">
        ...
        <div class="contenido">
            ...
            <div class="col-md-12" style="margin-bottom: 10px">
                ...
                <g:if test="${gestorInstance && tieneAsientos}">
            ...
            <table class="table table-bordered table-hover table-condensed" width="1060">
                <thead>
                <tr style="width: 100%">
                    <th style="width: 34%;" class="letraP">Código (Cuenta)</th>
                    <th style="width: 9%" class="letraP">% B. Imponible</th>
                    <th style="width: 9%" class="letraP">% B.I. Sin IVA</th>
                    <th style="width: 8%" class="letraP">Impuestos</th>
                    <th style="width: 8%" class="letraP">ICE</th>
                    <th style="width: 8%" class="letraP">Flete</th>
                    <th style="width: 8%" class="letraP">Valor</th>
                    <th style="width: 6%" class="letraP">D / H</th>
                    <th style="width: 10%" class="letraP">Acciones</th>
                </tr>
                </thead>
            </table>
...
<script type="text/javascript">
    ...
    $("#btnRegistrar").click(function () {
        bootbox.dialog({
            ...
            message: "<strong style='font-size: 14px'> Está seguro que desea registrar el gestor contable? </br> Una vez registrado, la información NO podrá ser cambiada.</strong>",
            buttons: {
                cancelar: {
    ...
    $("#btnDesRegistrar").click(function () {
        bootbox.dialog({
            title: "<i class='fa fa-exclamation-triangle fa-2x pull-left text-warning text-shadow'></i> Alerta",
            message: "<p style='font-size: 14px; font-weight: bold'> Está seguro que desea quitar el registro al gestor contable?",
            buttons: {
                cancelar: {
                    label: "<i class='fa fa-times'></i> Cancelar",
                    className: "btn-primary",
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (parts[0] === 'ok') {
                    log(parts[1], "success");
                    setTimeout(function () {
                        location.href = "${createLink(controller: 'gestor', action: 'formGestor')}/" + parts[2]
                    }, 800);
                } else {
                    log(parts[1], "error")
                }
