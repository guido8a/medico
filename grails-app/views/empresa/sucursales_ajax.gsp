...
<script type="text/javascript">
    ...
    $(".btnAgregarSucursal").click(function () {
        ...
        if(numero === '' || nombre === '' || direccion === ''){
            bootbox.alert("<i class='fa fa-exclamation-triangle fa-2x pull-left text-warning text-shadow'></i> <p style='font-weight: bold; font-size: 16px'> Ingrese todos los campos </p>")
        }else{
