...
<div class="btn-toolbar toolbar">
    <div class="btn-group">
        <g:link class="btn btn-primary" controller="proceso" action="buscarPrcs" id="${proceso?.paciente?.id}">
            <i class="fa fa-arrow-left"></i> Lista de Procesos
        </g:link>
        <g:link class="btn btn-info btn-ajax" id="${proceso?.id}" controller="proceso" action="procesoForm">
...
<div class="col-xs-12 breadcrumb" style="text-align: center; margin-bottom: 20px">
