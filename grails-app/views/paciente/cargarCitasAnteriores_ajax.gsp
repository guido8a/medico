...
<fieldset class="borde_abajo" style="position: relative;width: 670px;padding-left: 50px;">
    ...
    <g:uploadForm action="uploadCitasAnteriores" method="post" name="frmUpload" enctype="multipart/form-data"  >
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if(result){
                    $.ajax({
                        type: 'POST',
                        url: '${createLink(controller: 'paciente', action: 'borrarDocCitasAnteriores_ajax')}',
                        data:{
                            id: '${paciente?.id}'
                        },
